...
var AppView = Backbone.View.extend({
  ...
  template: _.template('<div class="container container-fluid"><div class="player-view row"></div><div class="content row"></div></div>'),
  el: '.app-view',
  ...
  render: function(){
    ...
    this.$('.player-view').append(this.playerView.$el);
    this.$('.content').append([
